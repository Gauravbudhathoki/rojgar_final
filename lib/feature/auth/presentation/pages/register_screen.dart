...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  void _handleRegister() {
    ...
    // Friend's logic: call ViewModel register
  ...
  Widget build(BuildContext context) {
    ...
    // Friend's logic: listen to auth state
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _inputField(controller: _usernameController, icon: Icons.person_outline, hint: "Username"),
              const SizedBox(height: 20),
              _inputField(controller: _emailController, icon: Icons.email_outlined, hint: "Email"),
              const SizedBox(height: 20),
              _inputField(controller: _passwordController, icon: Icons.lock_outline, hint: "Password", isPassword: true),
              const SizedBox(height: 20),
              _inputField(controller: _confirmPasswordController, icon: Icons.lock_outline, hint: "Confirm Password", isPassword: true),
              const SizedBox(height: 30),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    authState.status == AuthStatus.loading ? "SIGNING UP..." : "SIGN UP",
